...
var project0 = new _project__WEBPACK_IMPORTED_MODULE_0__.default('Default'); // show todo details
//// show todo views
...
var showTodos = function showTodos(project) {
  ...
  var _iterator = _createForOfIteratorHelper(project.todos),
      _step;
  ...
  var _iterator2 = _createForOfIteratorHelper(todosListeners),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var todoHTML = _step2.value;

      var _iterator3 = _createForOfIteratorHelper(project.todos),
          _step3;

      try {
        var _loop = function _loop() {
          var todoObj = _step3.value;

          if (todoHTML.innerHTML === todoObj.title) {
            todoHTML.addEventListener('click', function () {
              return _todo__WEBPACK_IMPORTED_MODULE_1__.default.showTodoDetails(todoObj);
            });
          }
        };
...
var projectsEvents = function projectsEvents() {
  ...
  var _iterator4 = _createForOfIteratorHelper(projectsListeners),
      _step4;

  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      var projectHTML = _step4.value;

      var _iterator5 = _createForOfIteratorHelper(_project__WEBPACK_IMPORTED_MODULE_0__.projects),
          _step5;

      try {
        var _loop2 = function _loop2() {
          var projectObj = _step5.value;
...
var addTodoFrm = function addTodoFrm(project) {
  var form = document.createElement('form');
  var title = document.createElement('input');
  var des = document.createElement('input');
  var dueDate = document.createElement('input');
  ...
  btn.addEventListener('click', function () {
    var todo = new _todo__WEBPACK_IMPORTED_MODULE_1__.default(title.value, des.value, dueDate.value, priority.value);
